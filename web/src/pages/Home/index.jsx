          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
              ...
              <div className="bg-white rounded-2xl p-8 border border-gray-100 hover:border-indigo-200 transition-all duration-300 hover:shadow-xl group dark:bg-gray-800 dark:border-gray-700 dark:hover:border-indigo-500">
                ...
                <p className="text-gray-700 leading-relaxed text-base dark:text-gray-300">聚灵API帮助我们显著提升了客户服务效率，智能对话系统让客服团队工作量减少了60%。</p>
              </div>
              {/* Testimonial 2 */}
              <div className="bg-white rounded-2xl p-8 border border-gray-100 hover:border-indigo-200 transition-all duration-300 hover:shadow-xl group dark:bg-gray-800 dark:border-gray-700 dark:hover:border-indigo-500">
                <div className="flex items-start mb-6">
                ...
                <p className="text-gray-700 leading-relaxed text-base dark:text-gray-300">作为一名设计师，聚灵API的图像生成功能给了我无限创作灵感，大大提升了工作效率。</p>
              </div>
              {/* Testimonial 3 */}
              <div className="bg-white rounded-2xl p-8 border border-gray-100 hover:border-indigo-200 transition-all duration-300 hover:shadow-xl group dark:bg-gray-800 dark:border-gray-700 dark:hover:border-indigo-500">
                <div className="flex items-start mb-6">
                ...
                <p className="text-gray-700 leading-relaxed text-base dark:text-gray-300">聚灵的企业版私有化部署方案完美满足了我们对数据安全的严格要求，技术支持也非常专业。</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="lg:col-span-3 space-y-6">
                  <div>
                    <div className="flex items-center gap-3 mb-3">
                      <img src="https://image.177911.com/image/logo.png" alt="Logo" className="w-10 h-10 object-contain" />
